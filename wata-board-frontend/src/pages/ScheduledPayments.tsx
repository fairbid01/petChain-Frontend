  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        {/* Floating action button — pinned to inline-end (right in LTR, left in RTL) */}
        {activeView === 'list' && (
          <button
            onClick={handleNewSchedule}
            className="fixed bottom-6 end-6 w-14 h-14 bg-sky-500 hover:bg-sky-400 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-slate-900"
